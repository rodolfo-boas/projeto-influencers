<!-- <header class="container-fluid navbar navbar-expand-sm navbar-light row align-items-baseline m-0"> -->
  ...
  <!-- <header> -->
     <nav class="container-fluid navbar navbar-expand-sm navbar-light row align-items-baseline m-0">
  ...
  <div class="collapse navbar-collapse" id="navbarText">
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" data-toggle="modal" data-target=".bd-cliente-modal-lg" 
        >Cliente</a>
      </li>
      <li class="nav-item">
